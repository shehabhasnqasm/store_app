...
//
  ...
  static Color pink800 = Colors.pink.shade700;
  static Color starterColor = Colors.pink;
  static Color endColor = Colors.red; //

  //
  static Color blackwhite54 = const Color(0xFFBA68C8); //purple 300
  ///
  // static Color gradiendLEnd = const Color(0xFFE91E63); //Pink
  // static Color gradiendLStart =  Color(0xFF9C27B0); //purple 500

  static Color gradiendLEnd = Colors.red;
  static Color gradiendLStart = Colors.pink; //Pink
