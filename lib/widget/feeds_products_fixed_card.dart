...
class FeedProductsFixedCard extends StatelessWidget {
  const FeedProductsFixedCard({super.key});
                ...
                return Padding(
                  ...
                  child: MaterialButton(
                    ...
                    onPressed: cartProvider.getCartItems
                            .containsKey(productsAttributes.id)
                        ? () {
                            cartProvider.removeItem(productsAttributes.id);
                          }
                        : () {
                    ...
                    child:
                        cartProv.getCartItems.containsKey(productsAttributes.id)
                            ? Row(
